...
if __name__ == "__main__":
    ...
    print('*** S(298.15K) computed (J/kg.K): %f ***' % s)
    print()
    print('*** Hf(298.15K) computed (J/mol): %f ***' % (hf/1000.0*MW))
    print('*** Hf(298.15K) - Hf(0K) computed (J/mol): %f ***' % (dhf/1000.0*MW))
    print('*** S(298.15K) computed (J/mol.K): %f ***' % (s/1000.0*MW))
